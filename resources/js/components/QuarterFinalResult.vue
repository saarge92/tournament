<template>
    ...
    <div class="quarter_final_block">
        ...
        <div class="quarter_final_full_info"
             v-for="quarterFinal in this.playoffResults.quarter_final[0]['result_matches']">
        ...
        <div class="quarter_final_full_info">
            ...
            <span v-for="(quarterFinal,index) in this.playoffResults.quarter_final[0]['team_winners']">
